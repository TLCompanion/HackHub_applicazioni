...
class CreaHackathonBoundaryIT extends BaseHttpIT {
    ...
    private static final String ENDPOINT = "/api/hackathon/crea";
    ...
    void creaHackathon_ok() throws Exception {
        ...
        assertAll(
                ...
                () -> assertEquals(LocalDateTime.of(2030, 6, 10, 23, 59), hackathon.getScadenzaIscrizioni())
        );
        ...
        return """
               {
                 ...
                 "maxIscrizioni": 20,
                 "scadenzaIscrizioni": "2030-06-10T23:59:00",
                 "nomeGiudice": "%s",
                 "nomeMentori": %s
               }
    ...
    private Hackathon creaHackathonValido() {
        return new Hackathon(
                ...
                5,
                3,
                LocalDateTime.of(2030, 6, 10, 23, 59),
