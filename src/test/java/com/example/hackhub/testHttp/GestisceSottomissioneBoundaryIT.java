...
class GestisceSottomissioneBoundaryIT {
    ...
    void setUp() {
        ...
        Utente leader = repositoryUtenti.saveAndFlush(new Utente(NOME_UTENTE, "leader@test.it", "hash"));
        Utente membro2 = repositoryUtenti.saveAndFlush(new Utente(ALTRO_UTENTE, "membro2@test.it", "hash"));
