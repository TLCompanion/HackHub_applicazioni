...
@Transactional
class RispondeRichiesteSupportoBoundaryIT {
    ...
    void setUp(){
        ...
        repositoryUtenti.saveAndFlush(new Utente(MENTORE, MENTORE + "@example.com", "pwd"));
        repositoryUtenti.saveAndFlush(new Utente(DEST, DEST + "@example.com", "pwd"));
    ...
    void rispondiRichiestaSupporto_ok() throws Exception {
        Utente destinatario = repositoryUtenti.findByNomeUtente(DEST).orElseThrow();
        ...
        Staff staff = new Staff(repositoryUtenti.findByNomeUtente(MENTORE).orElseThrow(), RuoloStaff.MENTORE);
